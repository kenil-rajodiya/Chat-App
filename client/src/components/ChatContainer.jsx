...
const ChatContainer = () => {
  ...
  useEffect(() => {
    if (!initialScrollDone && scrollEnd.current && messages?.length > 0) {
  ...
  return showMobileMedia ? (
    <MobileMedia onClose={() => setShowMobileMedia(false)} />
  ) : (
      ...
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        ...
        <img
          onClick={() => {
            ...
            setShowMobileMedia(true); // ✅ now shows MobileMedia
          }}
